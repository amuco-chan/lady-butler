...
function TasksPage({ tasks, edit, remove, complete }: { tasks: Task[]; edit: (t: Task) => void; remove: (id: string) => void; complete: (id: string) => void }) {
  ...
  return <><PageHeading eyebrow="TODO" title="やること"><>{tasks.filter(t => t.status !== '完了').length}件の未完了のやることがあります。完了したら消えるものだけを置きましょう。</></PageHeading>
    <section className="boundary-guide card"><div><CheckCircle2 size={18}/><strong>やること</strong><span>提出・買い物・連絡など、完了したらチェックするもの</span></div><div><CalendarDays size={18}/><strong>予定</strong><span>授業・バイト・面談など、開始時刻が決まっているもの</span></div></section>
...
function CalendarPage({ events, add, edit, remove }: { events: CalendarEvent[]; add: () => void; edit: (event: CalendarEvent) => void; remove: (id: string) => void }) {
  ...
  return <>
    ...
    <section className="boundary-guide card"><div><CalendarDays size={18}/><strong>予定</strong><span>何月何日・何時から、と時間の枠があるもの</span></div><div><CheckCircle2 size={18}/><strong>やること</strong><span>締切までに終わらせるもの。提出・買い物・連絡など</span></div></section>
